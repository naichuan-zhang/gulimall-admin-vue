<template>
  <div class="mod-menu">
    ...
    <!-- 弹窗, 新增 / 修改 -->
    <menu-add-or-update v-if="addOrUpdateVisible" ref="addOrUpdate" @refreshDataList="getDataList"></menu-add-or-update>
  </div>
</template>

<script>
import {isAuth, treeDataTranslate} from '@/utils'
import MenuAddOrUpdate from '@/views/modules/sys/menu-add-or-update'
export default {
